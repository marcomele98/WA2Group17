...
CREATE SEQUENCE IF NOT EXISTS attachment_seq INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS message_seq INCREMENT BY 1;
--CREATE SEQUENCE IF NOT EXISTS products_seq INCREMENT BY 1;
--CREATE SEQUENCE IF NOT EXISTS profile_skills_seq INCREMENT BY 1;
--CREATE SEQUENCE IF NOT EXISTS profiles_seq INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS status_changes_seq INCREMENT BY 1;
CREATE SEQUENCE IF NOT EXISTS tickets_seq INCREMENT BY 1;
